...
import Areadata from "../../components/elements/Areadata";
...
const Area = () => {
  ...
  const fetchData = async () => {
    const request = await axios.get(`${import.meta.env.VITE_APP_API_URL}area`, {
      headers: {
  ...
  const columns = [
    ...
    },
    {
      header: "Sub Category",
      sortable: true,
      accessorKey: "subcategory.displaylabel",
    },
  ];
  return (
