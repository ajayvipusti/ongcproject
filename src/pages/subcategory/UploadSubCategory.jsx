...
import SubCategoryUploadExcel from "../../components/elements/SubCategoryUploadExcel";
    ...
    if (file) {
      try {
        ...
        const request = await axios.post(
          `${import.meta.env.VITE_APP_API_URL}subcategory/import`,
          formData,
          {
            headers: {
