    ...
    <div className="bg-white w-full flex flex-col p-6 py-4 rounded-sm shadow-md">
      <div className="flex items-center justify-between px-2 py-2">
        <div className="flex items-center justify-center">
          ...
          <span className="text-lg font-medium uppercase text-teal-500">
            Upload Category Data
          </span>
        </div>
        <a
          href={"/assets/ExportCategory.xlsx"}
          download={"ExportCategory.xlsx"}
        >
      ...
      <div className="w-full border-t border-gray-200">
        ...
        <div className="border p-2 px-4 border-teal-100 bg-teal-50 shadow-md mt-4 rounded-sm w-full">
          <span className="text-base text-teal-500">
            Excel file must follow below format:
          </span>
          <br />
          <span className="text-base font-semibold text-teal-500">
            [ID , Entity Type , Display Label , Phase ID , Category_c ,
            IMPMCategory_c]
          </span>
        </div>
        <div className="flex justify-center py-6 text-base">
          ...
          <div className="px-4">
            <label>
              <span className="px-4 shadow-md py-1.5 border-red-500 rounded-sm uppercase cursor-pointer text-xs text-red-500 border-[1.5px] font-semibold">
            ...
            <div className="py-4 flex items-center">
              <span className="uppercase px-2 shadow-md font-bold text-white text-xxs py-0 bg-teal-500">
                Note
              </span>
              <br />
              <span className="px-2 font-normal">
                File must be a XLS or XLSX
              </span>
            </div>
          </div>
        </div>
        <div className="flex justify-center items-center p-2">
          <button
            ...
            className="uppercase border border-teal-500 hover:bg-transparent hover:text-teal-500 delay-100 duration-100 transition-all font-semibold px-4 py-1.5 shadow-md rounded-sm bg-teal-500 text-white mr-4"
          >
            upload
          </button>
          <button
            onClick={() => navigate("/admin/categoryinfo")}
            className="uppercase border border-teal-500 hover:bg-transparent hover:text-teal-500 delay-100 duration-100 transition-all font-semibold px-4 py-1.5 shadow-md rounded-sm bg-teal-500 text-white"
          >
            Back
          </button>
...
export default CategoryUploadExcel;
