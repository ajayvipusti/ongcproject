...
const SubCategoryUploadExcel = ({handleFileChange, handleUpload, file,formRef}) => {
  ...
  return (
    <div className='bg-white w-full flex flex-col p-6 py-4 rounded-sm shadow-md'>
        ...
        <TbBrandTelegram className='text-teal-500 mx-1' size={20}/>
            <span className='text-lg font-medium uppercase text-teal-500'>Upload SubCategory Data</span>
            </div>
            <a href={('/assets/ExportSubcategory.xlsx')} download={"ExportSubcategory.xlsx"} >
        ...
        <div className='w-full border-t border-gray-200'>
            ...
            <button  onClick={() => navigate('/admin/subcategoryinfo')}  className='uppercase border border-teal-500 hover:bg-transparent hover:text-teal-500 delay-100 duration-100 transition-all font-semibold px-4 py-1.5 shadow-md rounded-sm bg-teal-500 text-white'>Back</button> 
...
export default SubCategoryUploadExcel